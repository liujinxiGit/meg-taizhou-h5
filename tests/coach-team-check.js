...
const checks = [
  ...
  ["Majie Chinese profile owns the verified education and certifications", majieZh.includes("coach-majie.webp?v=20260818-2") && ["马杰", "休闲体育本科", "国家健身教练职业认证", "IBFA", "增肌", "减脂", "功能性训练", "循序渐进"].every(value => majieZh.includes(value))],
