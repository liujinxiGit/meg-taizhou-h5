...
const checks = [
  ...
  ["English root resources cannot resolve under /en/", en.includes('href="/styles.css?v=20260804-4"') && en.includes('src="/config.js?v=20260804-4"') && en.includes('src="/app.js?v=20260804-4"') && !/src="(?:\.\/)?app\.js/.test(en)],
  ["Scripts defer until the DOM is ready", /<script defer src="\/config\.js\?v=20260804-4"><\/script><script defer src="\/app\.js\?v=20260804-4"><\/script>/.test(zh) && /<script defer src="\/config\.js\?v=20260804-4"><\/script><script defer src="\/app\.js\?v=20260804-4"><\/script>/.test(en) && app.includes('document.addEventListener("DOMContentLoaded", init')],
