...
const checks = [
  ...
  ["Compact section menu and active-section logic exist", app.includes("openSectionMenu") && app.includes("aria-current") && app.includes("IntersectionObserver") && css.includes(".section-menu-button") && !css.includes(".section-nav{display:block}")],
