...
const checks = [
  ...
  ["Both pages use root resource paths and version 20260806-1", zh.includes('href="/styles.css?v=20260806-1"') && zh.includes('src="/app.js?v=20260806-1"') && en.includes('href="/styles.css?v=20260806-1"') && en.includes('src="/config.js?v=20260806-1"') && en.includes('src="/app.js?v=20260806-1"') && !en.includes('../app.js') && !en.includes('../config.js') && !en.includes('../styles.css')]
];
