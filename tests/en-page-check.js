...
const checks = [
  ...
  ["Both pages use root resource paths and current versions", zh.includes('href="/styles.css?v=20260818-2"') && zh.includes('src="/config.js?v=20260818-2"') && zh.includes('src="/app.js?v=20260818-2"') && en.includes('href="/styles.css?v=20260818-2"') && en.includes('src="/config.js?v=20260818-2"') && en.includes('src="/app.js?v=20260818-2"') && !en.includes('../app.js') && !en.includes('../config.js') && !en.includes('../styles.css')]
];
