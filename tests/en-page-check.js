...
const checks = [
  ...
  ["Both pages use resource version 20260731-2", zh.includes("styles.css?v=20260731-2") && zh.includes("app.js?v=20260731-2") && en.includes("../styles.css?v=20260731-2") && en.includes("../app.js?v=20260731-2")]
];
