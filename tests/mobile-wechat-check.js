...
const checks = [
  ...
  ["Static resources use current cache versions", [zh, en].every(html => html.includes("/styles.css?v=20260818-2") && html.includes("/config.js?v=20260818-2") && html.includes("/app.js?v=20260818-2"))]
];
