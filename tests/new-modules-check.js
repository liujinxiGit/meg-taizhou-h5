...
const checks = [
  ...
  ["14. PAC information is accurate", ["2016", "2024", "PAC购物中心1号楼", "昌平路地铁站2号口", "约190㎡"].every(value => zh.includes(value)) && ["Established in 2016", "relocated to PAC Mall in 2024", "Building 1, PAC Mall", "Changping Road Metro Station, Exit 2", "Around 190㎡"].every(value => en.includes(value))],
  ...
  ["18. Brand timeline order is accurate", ordered(block(zh, "brand-timeline", "never") || zh.slice(zh.indexOf("data-brand-timeline")), ["2016", "2021", "2024", "2026"]) && ordered(en.slice(en.indexOf("data-brand-timeline")), ["2016", "2021", "2024", "2026"])],
