window.MEG_CONFIG = {
  ...
  managerName: "店长（待补充）",
  managerWechat: "待补充",
  managerQr: "assets/manager-wechat.png",
  ...
  gallery: [
    { src: "assets/gym-1.webp", label: "自由训练区" },
    { src: "assets/gym-2.webp", label: "力量器械区" },
    { src: "assets/gym-3.webp", label: "综合训练区" },
    { src: "assets/pilates-1.webp", label: "器械普拉提教室" },
    { src: "assets/pilates-2.webp", label: "普拉提设备" },
    { src: "assets/changing-room.webp", label: "更衣与储物空间" },
    { src: "assets/exterior.webp", label: "门店外观" }
  ],
  experiences: [
    {
