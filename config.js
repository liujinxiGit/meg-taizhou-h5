window.MEG_CONFIG = {
  ...
  showRemaining: false,
  accentColor: "#b8ff3d",
  heroImage: "assets/hero.webp?v=20260730-1",
  gallery: [
    { src: "assets/elevator.webp?v=20260730-1", label: "电梯厅" },
    { src: "assets/corridor.webp?v=20260730-1", label: "入店走廊" },
    { src: "assets/gym-1.webp?v=20260730-1", label: "自由训练区" },
    { src: "assets/gym-2.webp?v=20260730-1", label: "力量器械区" },
    { src: "assets/gym-3.webp?v=20260730-1", label: "综合训练区" },
    { src: "assets/pilates-1.webp?v=20260730-1", label: "器械普拉提教室" },
    { src: "assets/pilates-2.webp?v=20260730-1", label: "普拉提设备" },
    { src: "assets/changing-room.webp?v=20260730-1", label: "更衣与储物空间" },
    { src: "assets/shower.webp?v=20260730-1", label: "淋浴空间" }
  ],
  experiences: [
    {
